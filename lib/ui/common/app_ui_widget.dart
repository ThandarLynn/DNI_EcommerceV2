...
import 'package:dni_ecommerce_v2/ui/common/app_square_progress_widget.dart';
import 'package:dni_ecommerce_v2/viewobject/default_icon.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:dni_ecommerce_v2/viewobject/default_photo.dart';
  ...
  Widget build(BuildContext context) {
    if (defaultPhoto.imgPath == '') {
      ...
      final String fullImagePath =
          '${AppConfig.ps_app_image_url}${defaultPhoto.imgPath}';
      print('img path : $fullImagePath');
      final String thumbnailImagePath =
          '${AppConfig.ps_app_image_thumbs_url}${defaultPhoto.imgPath}';
...
class AppNetworkImageWithUrl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (imagePath == '') {
      ...
      final String fullImagePath = '${AppConfig.ps_app_image_url}$imagePath';
      final String thumbnailImagePath =
          '${AppConfig.ps_app_image_thumbs_url}$imagePath';
      ...
      if (photoKey == '') {
        ...
        return GestureDetector(
          ...
          child: CachedNetworkImage(
            ...
            height: height!,
            fit: boxfit,
            imageUrl: '${AppConfig.ps_app_image_url}$imagePath',
            errorWidget: (BuildContext context, String url, Object? error) =>
                Image.asset(
              'assets/images/placeholder_image.png',
              width: width,
...
class PsNetworkCircleIconImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (defaultIcon.imgPath == '') {
      ...
      final String fullImagePath =
          '${AppConfig.ps_app_image_url}${defaultIcon.imgPath}';
      final String thumbnailImagePath =
          '${AppConfig.ps_app_image_thumbs_url}${defaultIcon.imgPath}';
      ...
      if (photoKey == '') {
        ...
        return GestureDetector(
          ...
          child: Hero(
              tag:
                  '$photoKey${AppConfig.ps_app_image_url}${defaultIcon.imgPath}',
              child: ClipRRect(
                borderRadius: BorderRadius.circular(10000.0),
                child: CachedNetworkImage(
                  placeholder: (BuildContext context, String url) {
