...
class AppColors {
  ...
  /// Common Theme
  ///
  static const Color _c_main_color = Color(0xFF64A1FF);
  static const Color _c_main_light_color = Color(0xFFEBFCFE);
  static const Color _c_main_dark_color = Color(0xFF88FCFE);
